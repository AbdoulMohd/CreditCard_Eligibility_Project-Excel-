...
1) **Is there a significant difference in credit card eligibility between different genders?**
   ...
   ![Male vs Female]([1Visualization\Male_vs_Female.png](https://github.com/AbdoulMohd/CreditCard_Eligibility_Project-Excel-/blob/main/1Visualization/Credit_Card_Eligibility_By_Gender.png))   ![](1Visualization\Credit_Card_Eligibility_By_Gender.png)
